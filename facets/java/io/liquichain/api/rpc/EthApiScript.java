...
public class EthApiScript extends Script {
    ...
    private String getTransactionByHash(String requestId, String hash){
       ...
       log.info("lookup transaction hexHash={}",hash.substring(2));  
    ...
    private String getTransactionCount(String requestId, String hash) {
      try {
        int nbTransaction = (crossStorageApi.find(defaultRepo, Transaction.class).by("fromHexHash", hash.toLowerCase()).getResults()).size();
